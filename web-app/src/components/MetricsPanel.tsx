  ...
  return (
    <div className="glass p-4 rounded-2xl">
      <div className="flex items-center justify-between mb-3">
        ...
        {loading && (
          <div className="w-4 h-4 border-2 border-accent-product border-t-transparent rounded-full animate-spin" />
        )}
      </div>
      ...
      {metrics ? (
        <div className="grid grid-cols-2 gap-3">
          <div className="glass-subtle rounded-xl p-3">
            ...
            <div className="text-xl font-bold text-charcoal">{metrics.iterations ?? 0}</div>
          </div>
          <div className="glass-subtle rounded-xl p-3">
            <div className="text-[10px] font-semibold text-slate uppercase tracking-wider mb-1">Gate Pass Rate</div>
          ...
          <div className="glass-subtle rounded-xl p-3">
            <div className="text-[10px] font-semibold text-slate uppercase tracking-wider mb-1">Tokens Used</div>
            <div className="text-xl font-bold text-charcoal">
              {(metrics.tokens_used ?? 0).toLocaleString()}
            </div>
          </div>
          <div className="glass-subtle rounded-xl p-3">
            <div className="text-[10px] font-semibold text-slate uppercase tracking-wider mb-1">Time Elapsed</div>
            <div className="text-xl font-bold text-charcoal">
        ...
        <div className="text-sm text-slate py-4 text-center">
